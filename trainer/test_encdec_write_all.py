...
from models.model_test_destination_write_all import model_encdec
...
class Trainer:
    ...
    def evaluate(self, dataset):
        ...
        self.mem_n2n.write_all(self.train_dataset)
        ...
        with torch.no_grad():
            for i, (traj, mask, initial_pos,seq_start_end) \
                ...
                future_rep = destination[:, -1:, :].unsqueeze(1).repeat(1, 20, 1, 1)
                ...
                fde_48s += torch.sum(min_distances[:, 0])
